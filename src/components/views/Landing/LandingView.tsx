...
const LandingView: React.FC = () => {
  ...
  return (
    <LandingContainer>
      <TopBar>
        <Filler />
        <TextButton onClick={handleCreateTree} style={{ margin: 0 }}>Start writing</TextButton>
      </TopBar>
      <ContainerVertical style={{ maxWidth: '700px', margin: '0 auto', alignItems: 'center' }}>
        ...
        <a href="https://www.lesswrong.com/posts/JHsfMWtwxBGGTmb8A/pantheon-interface"> Learn more about the project</a>
      </ContainerVertical>
    </LandingContainer>
  );
};
