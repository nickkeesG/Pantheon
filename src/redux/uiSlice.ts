...
const uiSlice = createSlice({
  ...
  reducers: {
    ...
    setIncomingComment(state, action: PayloadAction<{ daemonName?: string, ideaId?: number, isRight?: boolean }>) {
      if (action.payload.daemonName && action.payload.ideaId && action.payload.isRight !== undefined) {
...
export const { setLastTimeActive, setActiveTreeId, setActiveSectionId, setActiveIdeaIds, setActiveView, setCreatingSection, createBranch, setIncomingComment, resetUiSlice } = uiSlice.actions;
